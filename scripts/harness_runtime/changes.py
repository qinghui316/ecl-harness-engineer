    ...
    if due:
        ...
        atomic_write_json(
            skill_root / "state" / "evolution" / "pending.json",
            {
                ...
                "required_flow": [
                    "Ask for periodic Harness review approval (E1)",
                    "Acquire the exclusive Evolution lease and write lock",
                    "Create proposal and staged candidate",
                    "Run independent review and required validation",
                    "Record keep, rejected, or noop without E2",
                ],
                "updated_at": utc_now(),
            },
        )
